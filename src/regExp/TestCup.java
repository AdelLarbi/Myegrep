...
public class TestCup extends java_cup.runtime.lr_parser {
     ...
     */
    public TestCup(java_cup.runtime.Scanner s) {
        super(s);
    }
     ...
     * Constructor which sets the default scanner.
     */
    public TestCup(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {
        super(s, sf);
    }
        ...
        switch (CUP$TestCup$act_num) {
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
            case 1: // $START ::= expr_list EOF
            {
                ...
                Object start_val = ((java_cup.runtime.Symbol) CUP$TestCup$stack.elementAt(CUP$TestCup$top - 1)).value;
                RESULT = start_val;
